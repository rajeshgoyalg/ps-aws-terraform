...
#       source_security_group_id = var.service_security_groups
#     }
#     egress_all = {
#       type        = "egress"
#       from_port   = 0
...
module "ecs_service" {  
  ...
  # Add health check grace period for load balancer  
  ...
  # Capacity provider strategy - using the same as your cluster  
  ...
  # Propagate tags from the service to the tasks  
